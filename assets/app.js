...
function calculateProfitAndLoss(earlyPrice, stockQty, presentPrice) {
    ...
    if (earlyPrice > presentPrice) {
        ...
        let lossPercentage = calculatePercenatage(loss, earlyPrice);
    ...
    if(earlyPrice < presentPrice) {
        ...
        let profitPercentage = calculatePercenatage(profit, earlyPrice);
...
function calculatePercenatage(number, total) {
